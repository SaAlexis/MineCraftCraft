...
namespace Mine2Craft.Test.Persistance
{
    public class BddContext : DbContext
    {
        ...
        {
            optionsBuilder.UseSqlServer(@"Server=DESKTOP-KN0N952\ALEXPRESS;User id=sa;Password = mdpbdd;Initial Catalog=Mine2Craft;Integrated Security=True;"); //, x => x.MigrationsAssembly("CodeFirstNewDatabaseSample.Migrations")
        }
